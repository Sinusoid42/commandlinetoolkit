...
const CLI_VERBOSE_SIMPLE = 0b0000001
const CLI_VERBOSE_COMPLEX = 0b0000010
const CLI_VERBOSE_PARSING = 0b0000100
const CLI_VERBOSE_SHELL = 0b0001000
const CLI_VERBOSE_OS_SIG = 0b0010000
const CLI_VERBOSE_SHELL_PARSE = 0b0100000
const CLI_VERBOSE_PREDICT = 0b01000000
const CLI_VERBOSE_SHELL_BUFFER = 0b10000000
