...
const CLI_VERBOSE_SIMPLE = 0b000001
const CLI_VERBOSE_COMPLEX = 0b000010
const CLI_VERBOSE_PARSING = 0b000100
const CLI_VERBOSE_SHELL = 0b001000
const CLI_VERBOSE_OS_SIG = 0b010000
const CLI_VERBOSE_SHELL_PARSE = 0b100000
const CLI_VERBOSE_PREDICT = 0b1000000
