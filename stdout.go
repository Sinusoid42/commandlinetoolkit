...
func (s *shellHandler) processState() bool {
	...
	s._historyFileHandler.iterateHistory(s)
...
func (s *shellHandler) requestSuggestionsOnTab() {
	...
	if s._currentPredictionAvailable || s._prevKeyFromStdin != KEY_TAB {
		return
	}
...
func (s *shellHandler) read() {
	...
	*/
	...
	s._debugHandler.debugBuffer(s._prevKeyFromStdin)
